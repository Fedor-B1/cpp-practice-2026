...
// Условие: Вы едете из города A в город B. Бак вмещает C литров. На пути есть заправки на расстояниях d[0], d[1], ..., d[n-1] от старта. В каждой заправке можно заправиться до полного бака. Изначально бак полон. Найдите минимальное число заправок, чтобы доехать. Если невозможно — верните -1.
